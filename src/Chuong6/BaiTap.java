...
public class BaiTap
{
    ...
    public static void tamGiacVuongBenDuoi(int chieuCao)
    {
        ...
        {
            /*
            Số lần in dấu sao cho mỗi hàng chính là hang + 1 vì hàng 0 cần 1 dấu sao, hàng 1 cần 2 dấu sao, v.v.
             Cụ thể: Hàng đầu tiên: hang = 0, chỉ có 1 cột cot = 0 được in dấu sao. Hàng thứ 2: hang = 1, sẽ có 2 cột cot = 0 và 1 được in dấu sao, v.v.
            */
    ...
    public static void tamGiacVuongBenTren(int chieuCao)
    {
        ...
        Duyệt qua từng hàng, bắt đầu từ hàng cuối cùng (chieuCao - 1) và giảm dần
         Ví dụ: nếu chiều cao tam giác là 5, thì cot sẽ được gán giá trị 5 - 1 = 4, tức là bắt đầu từ hàng 4 (hàng cuối cùng trong tam giác vuông gốc)
         Dừng sau khi hang giảm xuống 0 vì duyệt từ dưới lên trên
        */
